...
public class Rectangle extends Color {
    ...
    public Rectangle(int a_side_length, int b_side_length, int color_red, int color_green, int color_blue, int hue, int saturation, int brightness ) {
        ...
        if (a_side_length == b_side_length) {
            System.out.println("This isn`t rectangle. It is square");
            System.exit(0);
        }
    }
